                            ...
                            <div>
                                <div className="flex items-center mb-10">
                                    <div className="p-2 rounded-full mr-6 bg-gray-100">
                                        <svg className="text-gray-700 fill-current" width="18" height="18" viewBox="0 0 18 18"
                                    ...
                                    <div>
                                        <span className="block text-xs font-medium text-yellow-100">Telephone Number</span>
                                        <span className="block font-medium text-yellow-50"><a href="tel:+27813434552">(+27) 81 343 4552</a></span>
                                    </div>
                                </div>
                            </div>
                            <div className="flex items-center mb-10">
                                <div className="p-2 rounded-full mr-6 bg-gray-100">
                                    <svg className="text-gray-700 fill-current" width="16" height="12" viewBox="0 0 16 12" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <div>
                                    <span className="block text-xs font-medium text-yellow-100">Email Address</span>
                                    <span className="block font-medium text-yellow-50"><a href="mailto:accounting@business.com">
                                        accounting@business.com</a></span>
                                </div>
                            </div>
                            <div className="flex items-center mb-10">
                                ...
                                <div>
                                    <span className="block text-xs font-medium text-yellow-100">Physical Address</span>
                                    <span className="block font-medium text-yellow-50">3 Abbey Rd, London, United Kingdom</span>
                                </div>
                            </div>
                        </div>
