                        ...
                        <div className="flex flex-col-reverse md:grid md:grid-cols-5">
                            <div className="flex min-h-0 flex-col col-start-1 col-end-3 md:mr-6">
                                <div className="mt-2 md:mt-0"><span className="uppercase font-semibold text-gray-700 text-xs">Ideas</span><span
                                    className="text-gray-400 mx-2 font-medium text-sm">August 20, 2021</span></div>
                                <h2 className="font-workSans text-2xl font-semibold my-2 text-gray-700">How to Use Organic SEO</h2>
                                <p className="text-sm mb-6 flex-grow text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    Possimus eligendi libero sit nihil tempora, totam reprehenderit aliquam beatae obcaecati ratione. Libero
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-2 text-xs">
                                        <span className="block font-semibold text-gray-700">John Something</span>
                                        <span className="block font-medium text-gray-500">Editor</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <a href="/blog"
                                ...
                                <div className="flex flex-col ">
                                    <div className="mt-2"><span className="uppercase font-semibold text-gray-700 text-xs">Productivity</span><span
                                        className="text-gray-400 mx-2 font-medium text-sm">Jan 9, 2021</span></div>
                                    <h2 className="font-workSans text-2xl font-semibold my-2 text-gray-700">How to Source the Best Beans</h2>
                                    <p className="text-sm mb-6 flex-grow text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                        Possimus eligendi libero sit nihil tempora, totam reprehenderit aliquam beatae obcaecati ratione.
                                        Libero
                                        consequatur cumque magnam ipsam quae sequi laudantium pariatur veritatis? </p>
                                    <div className="flex items-center">
                                        <div className="h-12 w-12 rounded-md overflow-hidden flex-shrink-0">
                                        ...
                                        <div className="ml-2 text-xs">
                                            <span className="block font-semibold text-gray-700">Kyle Chasse</span>
                                            <span className="block font-medium text-gray-500">Chief Technical Writer</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="/blog"
                                ...
                                <div className="flex flex-col">
                                    <div className="mt-2"><span className="uppercase font-semibold text-gray-700 text-xs">Advice</span><span
                                        className="text-gray-400 mx-2 font-medium text-sm">Dec 2, 2020</span></div>
                                    <h2 className="font-workSans text-2xl font-semibold my-2 text-gray-700">Handling Fiery Clients
                                    </h2>
                                    <p className="text-sm mb-6 flex-grow text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                        Possimus eligendi libero sit nihil tempora, totam reprehenderit aliquam beatae obcaecati ratione.
                                        Libero
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-2 text-xs">
                                            <span className="block font-semibold text-gray-700">Obi-Wan Kenobi</span>
                                            <span className="block font-medium text-gray-500">OG Psychologist</span>
                                        </div>
                                    </div>
                                </div>
                            </a>
